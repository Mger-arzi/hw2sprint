...
function Clock() {
    ...
    const stringDay = new Intl.DateTimeFormat("en-US" , {weekday:"long" })|| <br/> // пишут студенты
    const stringMonth =new Intl.DateTimeFormat("en-US", {month: "long",}) || <br/> // пишут студенты
